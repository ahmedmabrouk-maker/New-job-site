...
class Jobs_CPT {
	...
	public function register_post_type() {
		...
		// Job Activity Post Type
		$labels_activity = array(
			'name'                  => _x( 'Activities', 'Post Type General Name', 'jobs' ),
			'singular_name'         => _x( 'Activity', 'Post Type Singular Name', 'jobs' ),
			'menu_name'             => __( 'Activities', 'jobs' ),
		);
		$args_activity = array(
			'label'                 => __( 'Activity', 'jobs' ),
			'description'           => __( 'User Activities', 'jobs' ),
			'labels'                => $labels_activity,
			'supports'              => array( 'title', 'editor', 'author' ), // Author is important
			'hierarchical'          => false,
			'public'                => false,
			'show_ui'               => true,
			'show_in_menu'          => 'edit.php?post_type=job',
